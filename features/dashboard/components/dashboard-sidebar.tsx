...
export function DashboardSidebar() {
  ...
  const otherMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      url: "mailto:jesus.flo369@gmail.com",
      icon: Headphones,
    },
  ];
  return (
      ...
      <Sidebar collapsible="icon" className="w-72 b">
        <SidebarHeader className="flex flex-col gap-4 pt-4">
          <div className="flex flex-col items-center gap-2 pl-1 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:pl-0">
            <SidebarTrigger className="mr-auto lg:hidden" />
            <Image
              src="/logo.svg"
              alt="Resonance"
              width={24}
            ...
            <SidebarMenuItem>
              <OrganizationSwitcher
                ...
                appearance={{
                  elements: {
                    rootBox:
                      "w-full! group-data-[collapsible=icon]:w-auto! group-data-[collapsible=icon]:flex! grou-data-[collapsible=icon]:justify-center!",
